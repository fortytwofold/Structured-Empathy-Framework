...
1. **Clarify expectations early**  
   Define responsibilities, boundaries, and success criteria.
2. **Acknowledge emotional impact**  
   Normalise uncertainty, excitement, or apprehension.
3. **Establish support structures**  
   Identify mentors, peers, and check‑in rhythms.
4. **Create early wins**  
   Provide achievable tasks that build confidence.
5. **Review progress collaboratively**  
